...
@section("main")
    <div class="container my-4">
        <h1 class="text-center">Welcome to Boolando Store</h1>
        <div class="home-images d-flex justify-content-center py-4">
            <img
                class="home-img pe-3"
        ...
        <p class="fs-5 fw-semibold py-3 text-center">
            ...
            <a class="text-danger" href="{{ route("products") }}">products</a>
